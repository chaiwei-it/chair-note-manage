<template>
  <div class="goodsAdd">
      ...
      <el-form-item label="专属类型" prop="typeId">
        <el-select v-model="form.exclusive" placeholder="请选择" @change="typeChange">
          <el-option
            v-for="item in goodsExclusive"
            :key="item.value"
            :label="item.label"
            :value="item.value">
          </el-option>
