<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="exclusive" label="专属类型" width="120" sortable> 
        <template slot-scope="scope">
          <el-tag v-if="scope.row.exclusive == 0" size="small" type="info">普通商品</el-tag>
          <el-tag v-if="scope.row.exclusive == 1" size="small" type="">新人专属</el-tag>
          <el-tag v-if="scope.row.exclusive == 2" size="small" type="">会员专属</el-tag>
