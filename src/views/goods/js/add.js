...
export default {
  data() {
    return {
      ...
      thumbnailImageData: {fireUrl: "goods/thumbnail"},
      oblongImageData: {fireUrl: "goods/oblong"},
      exhibitionImageData: {fireUrl: "goods/exhibition"},
      detailsData: {fireUrl: "goods/details"},
      details: {
